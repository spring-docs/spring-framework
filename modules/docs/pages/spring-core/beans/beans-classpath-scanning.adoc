...
(xref:beans:beans-annotation-config.adoc#beans-annotation-config[beans-annotation-config]) demonstrates how to provide a lot of the configuration
...
xref:orm:orm-general:orm-exception-translation.adoc#orm-exception-translation[Exception Translation].
...
For example, the `@Service` annotation mentioned xref:beans:beans-classpath-scanning:beans-stereotype-annotations.adoc#beans-stereotype-annotations[earlier]
...
see xref:beans:beans-factory-scopes:beans-factory-scopes-other.adoc#beans-factory-scopes-other[beans-factory-scopes-other]. As with the pre-built annotations for those scopes,
...
scoped objects. The reasoning is described in xref:beans:beans-factory-scopes:beans-factory-scopes-other.adoc#beans-factory-scopes-other-injection[beans-factory-scopes-other-injection].
...
The `@Qualifier` annotation is discussed in xref:beans:beans-annotation-config:beans-autowired-annotation-qualifiers.adoc#beans-autowired-annotation-qualifiers[beans-autowired-annotation-qualifiers].
