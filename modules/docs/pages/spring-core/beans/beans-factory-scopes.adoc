...
xref:beans:beans-factory-scopes:beans-factory-scopes-custom.adoc#beans-factory-scopes-custom[a custom scope.]
...
| xref:beans:beans-factory-scopes:beans-factory-scopes-singleton.adoc#beans-factory-scopes-singleton[singleton]
| (Default) Scopes a single bean definition to a single object instance for each Spring IoC
  container.

| xref:beans:beans-factory-scopes:beans-factory-scopes-prototype.adoc#beans-factory-scopes-prototype[prototype]
| Scopes a single bean definition to any number of object instances.

| xref:beans:beans-factory-scopes:beans-factory-scopes-other.adoc#beans-factory-scopes-request[request]
| Scopes a single bean definition to the lifecycle of a single HTTP request. That is,
  each HTTP request has its own instance of a bean created off the back of a single bean
  definition. Only valid in the context of a web-aware Spring `ApplicationContext`.

| xref:beans:beans-factory-scopes:beans-factory-scopes-other.adoc#beans-factory-scopes-session[session]
| Scopes a single bean definition to the lifecycle of an HTTP `Session`. Only valid in
  the context of a web-aware Spring `ApplicationContext`.

| xref:beans:beans-factory-scopes:beans-factory-scopes-other.adoc#beans-factory-scopes-application[application]
| Scopes a single bean definition to the lifecycle of a `ServletContext`. Only valid in
  the context of a web-aware Spring `ApplicationContext`.

| xref:websocket:websocket-stomp:websocket-stomp-websocket-scope.adoc#websocket-stomp-websocket-scope[websocket]
...
xref:beans:beans-factory-scopes:beans-factory-scopes-custom.adoc#beans-factory-scopes-custom-using[beans-factory-scopes-custom-using].
...
custom xref:beans:beans-factory-extension:beans-factory-extension-bpp.adoc#beans-factory-extension-bpp[bean post-processor], which holds a reference to
...
container, see xref:beans:beans-factory-nature:beans-factory-lifecycle.adoc#beans-factory-lifecycle[beans-factory-lifecycle].)
...
runtime more than once, see xref:beans:beans-dependencies:beans-factory-method-injection.adoc#beans-factory-method-injection[beans-factory-method-injection]
...
See xref:beans:beans-standard-annotations.adoc#beans-standard-annotations[here] for more details on JSR-330 overall.
====
...
bean definition (see xref:beans:beans-factory-scopes:beans-factory-scopes-other.adoc#beans-factory-scopes-other-injection-proxies[beans-factory-scopes-other-injection-proxies] and
...
see xref:aop:aop-proxying.adoc#aop-proxying[aop-proxying].
