...
* xref:beans:beans-factory-nature:beans-factory-lifecycle.adoc#beans-factory-lifecycle[beans-factory-lifecycle]
* xref:beans:beans-factory-nature:beans-factory-aware.adoc#beans-factory-aware[beans-factory-aware]
* xref:beans:beans-factory-nature:aware-list.adoc#aware-list[aware-list]
...
For details, see xref:beans:beans-annotation-config:beans-postconstruct-and-predestroy-annotations.adoc#beans-postconstruct-and-predestroy-annotations[beans-postconstruct-and-predestroy-annotations].
...
xref:beans:beans-factory-extension.adoc#beans-factory-extension[beans-factory-extension].
...
the xref:beans:beans-annotation-config:beans-postconstruct-and-predestroy-annotations.adoc#beans-postconstruct-and-predestroy-annotations[`@PostConstruct`] annotation or
...
`@Bean`. See xref:beans:beans-java:beans-java-bean-annotation.adoc#beans-java-lifecycle-callbacks[beans-java-lifecycle-callbacks]. Consider the following example:
...
unnecessarily couples the code to Spring. Alternatively, we suggest using
the xref:beans:beans-annotation-config:beans-postconstruct-and-predestroy-annotations.adoc#beans-postconstruct-and-predestroy-annotations[`@PreDestroy`] annotation or
...
xref:beans:beans-java:beans-java-bean-annotation.adoc#beans-java-lifecycle-callbacks[beans-java-lifecycle-callbacks]. Consider the following definition:
...
xref:beans:beans-factory-nature:beans-factory-lifecycle.adoc#beans-factory-lifecycle-default-init-destroy-methods[beans-factory-lifecycle-default-init-destroy-methods]). Note that this is the
...
accordance with the standard lifecycle callback contract xref:beans:beans-factory-nature:beans-factory-lifecycle.adoc#beans-factory-lifecycle[described previously]). This feature also enforces a consistent naming convention for
...
* The xref:beans:beans-factory-nature:beans-factory-lifecycle.adoc#beans-factory-lifecycle-initializingbean[`InitializingBean`] and
xref:beans:beans-factory-nature:beans-factory-lifecycle.adoc#beans-factory-lifecycle-disposablebean[`DisposableBean`] callback interfaces
...
xref:beans:beans-factory-nature:beans-factory-lifecycle.adoc#beans-factory-lifecycle-default-init-destroy-methods[preceding section].
...
xref:beans:context-introduction.adoc#context-introduction[context-introduction].
...
(as described in xref:beans:beans-dependencies:beans-factory-autowire.adoc#beans-factory-autowire[beans-factory-autowire]) can provide a dependency of type
...
xref:beans:beans-annotation-config:beans-autowired-annotation.adoc#beans-autowired-annotation[beans-autowired-annotation].
...
Besides `ApplicationContextAware` and `BeanNameAware` (discussed xref:beans:beans-factory-nature:beans-factory-aware.adoc#beans-factory-aware[earlier]),
...
| xref:beans:beans-definition:beans-factory-class.adoc#beans-factory-class[beans-factory-class]
...
| xref:cci:cci.adoc#cci[JCA CCI]

| `LoadTimeWeaverAware`
| Defined weaver for processing class definition at load time.
| xref:aop:aop-using-aspectj:aop-aj-ltw.adoc#aop-aj-ltw[aop-aj-ltw]
...
| xref:jmx:jmx-notifications.adoc#jmx-notifications[Notifications]

| `ResourceLoaderAware`
| Configured loader for low-level access to resources.
| xref:resources:resources.adoc#resources[resources]

| `ServletConfigAware`
| Current `ServletConfig` the container runs in. Valid only in a web-aware Spring
  `ApplicationContext`.
| xref:mvc:mvc.adoc#mvc[Spring MVC]
