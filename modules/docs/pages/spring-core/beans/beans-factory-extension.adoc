...
xref:beans:beans-factory-extension:beans-factory-extension-factory-postprocessors.adoc#beans-factory-extension-factory-postprocessors[beans-factory-extension-factory-postprocessors].
====
...
xref:dynamic-language:dynamic-language.adoc#dynamic-language[Dynamic Language Support].)
...
(described earlier in xref:beans:beans-factory-extension:beans-factory-extension-bpp.adoc#beans-factory-extension-bpp[beans-factory-extension-bpp]). While it is technically possible
