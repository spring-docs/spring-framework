...
of the application typically suffices (see xref:beans:context-introduction:context-create.adoc#context-create[context-create]). If you use the
...
xref:beans:beans-java.adoc#beans-java[Java-based configuration] for their Spring applications.

For information about using other forms of metadata with the Spring container, see:

* xref:beans:beans-annotation-config.adoc#beans-annotation-config[Annotation-based configuration]: Spring 2.5 introduced
  support for annotation-based configuration metadata.
* xref:beans:beans-java.adoc#beans-java[Java-based configuration]: Starting with Spring 3.0, many features
...
xref:beans:beans-dependencies.adoc#beans-dependencies[Dependencies] for more information.
...
`Resource` abstraction (as described in xref:resources:resources.adoc#resources[resources]), which provides a convenient
mechanism for reading an InputStream from locations defined in a URI syntax. In particular,
`Resource` paths are used to construct applications contexts, as described in xref:resources:resources-app-ctx.adoc#resources-app-ctx[resources-app-ctx].
====
...
xref:beans:beans-dependencies.adoc#beans-dependencies[Dependencies].
...
xref:beans:beans-basics:beans-factory-instantiation.adoc#beans-factory-instantiation[previous section]. Alternatively, use one or more
