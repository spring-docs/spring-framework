...
. xref:appendix:xml-custom:xsd-custom-schema.adoc#xsd-custom-schema[Author] an XML schema to describe your custom element(s).
. xref:appendix:xml-custom:xsd-custom-namespacehandler.adoc#xsd-custom-namespacehandler[Code] a custom `NamespaceHandler` implementation.
. xref:appendix:xml-custom:xsd-custom-parser.adoc#xsd-custom-parser[Code] one or more `BeanDefinitionParser` implementations
  (this is where the real work is done).
. xref:appendix:xml-custom:xsd-custom-registration.adoc#xsd-custom-registration[Register] your new artifacts with Spring.
...
* `BeanDefinitionHolder decorate(Node, BeanDefinitionHolder, ParserContext)`: Called
  ...
  xref:beans:beans-factory-scopes.adoc#beans-factory-scopes[scopes that Spring supports].
...
If we stick to xref:appendix:xml-custom.adoc#xsd-custom-introduction[the steps described previously], we start off
...
Again following xref:appendix:xml-custom.adoc#xsd-custom-introduction[the process described earlier],
