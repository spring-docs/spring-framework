...
xref:aop:aop-proxying.adoc#aop-proxying[force the use of CGLIB], in those (hopefully rare) cases where you
...
xref:aop:aop-proxying:aop-understanding-aop-proxies.adoc#aop-understanding-aop-proxies[aop-understanding-aop-proxies] for a thorough examination of exactly what this
