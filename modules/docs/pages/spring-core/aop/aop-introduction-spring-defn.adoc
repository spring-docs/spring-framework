...
API. Spring AOP remains backward-compatible. See xref:aop-api:aop-api.adoc#aop-api[the following chapter]
...
See xref:aop:aop-choosing.adoc#aop-choosing[aop-choosing] for a more complete discussion of the "`whys and wherefores`" of
each style.
====
