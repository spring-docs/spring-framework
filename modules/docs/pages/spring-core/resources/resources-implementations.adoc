...
* xref:resources:resources-implementations:resources-implementations-urlresource.adoc#resources-implementations-urlresource[resources-implementations-urlresource]
* xref:resources:resources-implementations:resources-implementations-classpathresource.adoc#resources-implementations-classpathresource[resources-implementations-classpathresource]
* xref:resources:resources-implementations:resources-implementations-filesystemresource.adoc#resources-implementations-filesystemresource[resources-implementations-filesystemresource]
* xref:resources:resources-implementations:resources-implementations-servletcontextresource.adoc#resources-implementations-servletcontextresource[resources-implementations-servletcontextresource]
* xref:resources:resources-implementations:resources-implementations-inputstreamresource.adoc#resources-implementations-inputstreamresource[resources-implementations-inputstreamresource]
* xref:resources:resources-implementations:resources-implementations-bytearrayresource.adoc#resources-implementations-bytearrayresource[resources-implementations-bytearrayresource]
