...
As discussed in the previous section, xref:validation:core-convert.adoc#core-convert[`core.convert`] is a
...
See xref:mvc:mvc-config:mvc-config-conversion.adoc#mvc-config-conversion[Conversion and Formatting] in the Spring MVC chapter.
