...
[[webflux-cors]]
= CORS
[.small]#xref:mvc:mvc-cors.adoc#mvc-cors[Web MVC]#
...
[[webflux-cors-intro]]
== Introduction
[.small]#xref:mvc:mvc-cors:mvc-cors-intro.adoc#mvc-cors-intro[Web MVC]#
...
== Processing
[.small]#xref:mvc:mvc-cors:mvc-cors-processing.adoc#mvc-cors-processing[Web MVC]#
...
== `@CrossOrigin`
[.small]#xref:mvc:mvc-cors:mvc-cors-controller.adoc#mvc-cors-controller[Web MVC]#
...
[.small]#xref:mvc:mvc-cors:mvc-cors-global.adoc#mvc-cors-global[Web MVC]#
...
== CORS `WebFilter`
[.small]#xref:mvc:mvc-cors:mvc-cors-filter.adoc#mvc-cors-filter[Web MVC]#

You can apply CORS support through the built-in
{api-spring-framework}/web/cors/reactive/CorsWebFilter.html[`CorsWebFilter`], which is a
good fit with xref:webflux:webflux-fn.adoc#webflux-fn[functional endpoints].
