...
[[webflux-view]]
= View Technologies
[.small]#xref:mvc:mvc-view.adoc#mvc-view[Web MVC]#
...
WebFlux. We assume you are already familiar with xref:webflux:webflux-dispatcher-handler:webflux-viewresolution.adoc#webflux-viewresolution[webflux-viewresolution].
...
== Thymeleaf
[.small]#xref:mvc:mvc-view:mvc-view-thymeleaf.adoc#mvc-view-thymeleaf[Web MVC]#
...
== FreeMarker
[.small]#xref:mvc:mvc-view:mvc-view-freemarker.adoc#mvc-view-freemarker[Web MVC]#
...
=== View Configuration
[.small]#xref:mvc:mvc-view:mvc-view-freemarker.adoc#mvc-view-freemarker-contextconfig[Web MVC]#
...
[.small]#xref:mvc:mvc-view:mvc-view-freemarker.adoc#mvc-views-freemarker[Web MVC]#
...
=== Form Handling
[.small]#xref:mvc:mvc-view:mvc-view-freemarker.adoc#mvc-view-freemarker-forms[Web MVC]#
...
==== The Bind Macros
[.small]#xref:mvc:mvc-view:mvc-view-freemarker.adoc#mvc-view-bind-macros[Web MVC]#
...
* xref:mvc:mvc-view:mvc-view-freemarker.adoc#mvc-views-form-macros[Input Macros]
* xref:mvc:mvc-view:mvc-view-freemarker.adoc#mvc-views-form-macros-input[Input Fields]
* xref:mvc:mvc-view:mvc-view-freemarker.adoc#mvc-views-form-macros-select[Selection Fields]
* xref:mvc:mvc-view:mvc-view-freemarker.adoc#mvc-views-form-macros-html-escaping[HTML Escaping]



[[webflux-view-script]]
== Script Views
[.small]#xref:mvc:mvc-view:mvc-view-script.adoc#mvc-view-script[Web MVC]#
...
=== Requirements
[.small]#xref:mvc:mvc-view:mvc-view-script.adoc#mvc-view-script-dependencies[Web MVC]#
...
=== Script Templates
[.small]#xref:mvc:mvc-view:mvc-view-script.adoc#mvc-view-script-integrate[Web MVC]#
...
== JSON and XML
[.small]#xref:mvc:mvc-view:mvc-view-jackson.adoc#mvc-view-jackson[Web MVC]#

For xref:webflux:webflux-dispatcher-handler:webflux-viewresolution.adoc#webflux-multiple-representations[webflux-multiple-representations] purposes, it is useful to be able to alternate
...
xref:webflux:webflux-reactive-spring-web:webflux-codecs.adoc#webflux-codecs[webflux-codecs] from `spring-web`, such as `Jackson2JsonEncoder`, `Jackson2SmileEncoder`,
or `Jaxb2XmlEncoder`.

Unlike other view technologies, `HttpMessageWriterView` does not require a `ViewResolver`
but is instead xref:webflux:webflux-config:webflux-config-view-resolvers.adoc#webflux-config-view-resolvers[configured] as a default view. You can
