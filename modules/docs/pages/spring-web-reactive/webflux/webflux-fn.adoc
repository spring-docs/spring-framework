...
[.small]#xref:mvc:webmvc-fn.adoc#webmvc-fn[Web MVC]#
...
the same xref:webflux:webflux-reactive-spring-web.adoc#webflux-reactive-spring-web[webflux-reactive-spring-web] foundation.
...
[[webflux-fn-overview]]
== Overview
[.small]#xref:mvc:webmvc-fn:webmvc-fn-overview.adoc#webmvc-fn-overview[Web MVC]#
...
through one of the built-in xref:webflux:webflux-reactive-spring-web:webflux-httphandler.adoc#webflux-httphandler[server adapters]:

* `RouterFunctions.toHttpHandler(RouterFunction)`
* `RouterFunctions.toHttpHandler(RouterFunction, HandlerStrategies)`

Most applications can run through the WebFlux Java configuration, see xref:webflux:webflux-fn:webflux-fn-running.adoc#webflux-fn-running[webflux-fn-running].
...
== HandlerFunction
[.small]#xref:mvc:webmvc-fn:webmvc-fn-handler-functions.adoc#webmvc-fn-handler-functions[Web MVC]#
...
For more on that, see xref:webflux-reactive-libraries:webflux-reactive-libraries.adoc#webflux-reactive-libraries[Reactive Libraries].
...
A functional endpoint can use Spring's xref:validation:validation.adoc#validation[validation facilities] to
apply validation to the request body. For example, given a custom Spring
xref:validation:validation.adoc#validation[Validator] implementation for a `Person`:
...
See xref:validation:validation-beanvalidation.adoc#validation-beanvalidation[Spring Validation].



[[webflux-fn-router-functions]]
== `RouterFunction`
[.small]#xref:mvc:webmvc-fn:webmvc-fn-router-functions.adoc#webmvc-fn-router-functions[Web MVC]#
...
[[webflux-fn-running]]
== Running a Server
[.small]#xref:mvc:webmvc-fn:webmvc-fn-running.adoc#webmvc-fn-running[Web MVC]#
...
xref:webflux:webflux-reactive-spring-web:webflux-httphandler.adoc#webflux-httphandler[HttpHandler] for server-specific instructions.

A more typical option, also used by Spring Boot, is to run with a
xref:webflux:webflux-dispatcher-handler.adoc#webflux-dispatcher-handler[`DispatcherHandler`]-based setup through the
xref:webflux:webflux-config.adoc#webflux-config[webflux-config], which uses Spring configuration to declare the
...
xref:webflux:webflux-dispatcher-handler.adoc#webflux-dispatcher-handler[DispatcherHandler] for how to run it):
...
[.small]#xref:mvc:webmvc-fn:webmvc-fn-handler-filter-function.adoc#webmvc-fn-handler-filter-function[Web MVC]#
...
xref:webflux:webflux-cors:webflux-cors-webfilter.adoc#webflux-cors-webfilter[`CorsWebFilter`].
