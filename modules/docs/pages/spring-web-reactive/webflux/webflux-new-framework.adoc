...
of RxJava or another reactive library. See xref:webflux-reactive-libraries:webflux-reactive-libraries.adoc#webflux-reactive-libraries[webflux-reactive-libraries] for more details.

NOTE: In addition to Reactive APIs, WebFlux can also be used with 
xref:kotlin:coroutines.adoc#coroutines[Coroutines] APIs in Kotlin which provides a more imperative style of programming.
...
including HTTP abstractions, Reactive Streams xref:webflux:webflux-reactive-spring-web:webflux-httphandler.adoc#webflux-httphandler[adapters] for supported
servers, xref:webflux:webflux-reactive-spring-web:webflux-codecs.adoc#webflux-codecs[codecs], and a core xref:webflux:webflux-reactive-spring-web:webflux-web-handler-api.adoc#webflux-web-handler-api[webflux-web-handler-api] comparable to
the Servlet API but with non-blocking contracts.

On that foundation, Spring WebFlux provides a choice of two programming models:

* xref:webflux:webflux-controller.adoc#webflux-controller[webflux-controller]: Consistent with Spring MVC and based on the same annotations
...
* xref:webflux:webflux-fn.adoc#webflux-fn[webflux-fn]: Lambda-based, lightweight, and functional programming model. You can think of
...
You can return reactive types (Reactor, RxJava, xref:webflux-reactive-libraries:webflux-reactive-libraries.adoc#webflux-reactive-libraries[or other])
...
xref:webflux:webflux-reactive-spring-web:webflux-httphandler.adoc#webflux-httphandler[common API] so that higher-level
xref:webflux:webflux-new-framework:webflux-programming-models.adoc#webflux-programming-models[programming models] can be supported across servers.

Spring WebFlux does not have built-in support to start or stop a server. However, it is
easy to xref:webflux:webflux-reactive-spring-web:webflux-web-handler-api.adoc#webflux-web-handler-api[assemble] an application from Spring configuration and
xref:webflux:webflux-config.adoc#webflux-config[WebFlux infrastructure] and xref:webflux:webflux-reactive-spring-web:webflux-httphandler.adoc#webflux-httphandler[run it] with a few
lines of code.
...
xref:webflux:webflux-new-framework:webflux-server-choice.adoc#webflux-server-choice[servers]. To configure the threading model for a server,
...
xref:webflux-client:webflux-client-builder.adoc#webflux-client-builder[configure] the `WebClient` directly.
