...
== WebSocket API
[.small]#xref:websocket:websocket-server.adoc#websocket-server[Same as in the Servlet stack]#
...
=== Server
[.small]#xref:websocket:websocket-server:websocket-server-handler.adoc#websocket-server-handler[Same as in the Servlet stack]#
...
xref:databuffers:databuffers.adoc#databuffers[Data Buffers and Codecs].
...
=== Handshake
[.small]#xref:websocket:websocket-server:websocket-server-handshake.adoc#websocket-server-handshake[Same as in the Servlet stack]#
...
=== Server Configation
[.small]#xref:websocket:websocket-server:websocket-server-runtime-configuration.adoc#websocket-server-runtime-configuration[Same as in the Servlet stack]#
...
=== CORS
[.small]#xref:websocket:websocket-server:websocket-server-allowed-origins.adoc#websocket-server-allowed-origins[Same as in the Servlet stack]#
