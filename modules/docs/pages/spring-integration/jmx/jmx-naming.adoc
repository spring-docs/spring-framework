...
If you prefer to use xref:jmx:jmx-interface:jmx-interface-metadata.adoc#jmx-interface-metadata[the annotation-based approach] to define
...
xref:jmx:jmx-naming:jmx-naming-metadata.adoc#jmx-naming-metadata[MetadataNamingStrategy], as the following example shows:
