...
xref:jms:jms-using:jms-mdp.adoc#jms-mdp[Message Listener Containers]. These elements are detailed in the
section of the xref:jms:jms.adoc#jms[JMS chapter] entitled xref:jms:jms-namespace.adoc#jms-namespace[JMS Namespace Support]. See that chapter for full details on this support
...
xref:jmx:jmx-naming:jmx-context-mbeanexport.adoc#jmx-context-mbeanexport[Configuring Annotation-based MBean Export].
...
xref:cache:cache-annotations:cache-annotation-enable.adoc#cache-annotation-enable[Enabling Caching Annotations] and
xref:cache:cache-declarative-xml.adoc#cache-declarative-xml[Declarative XML-based Caching] for details.
