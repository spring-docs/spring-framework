...
what the xref:jms:jms-receiving:jms-receiving-async-message-listener-adapter.adoc#jms-receiving-async-message-listener-adapter[`MessageListenerAdapter`]
provides).
...
If you prefer xref:jms:jms-namespace.adoc#jms-namespace[XML configuration], you can use the `<jms:annotation-driven>`
...
The existing support in xref:jms:jms-receiving:jms-receiving-async-message-listener-adapter.adoc#jms-receiving-async-message-listener-adapter[`MessageListenerAdapter`]
