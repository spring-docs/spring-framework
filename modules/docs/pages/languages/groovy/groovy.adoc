...
xref:beans:beans-basics:beans-factory-instantiation.adoc#groovy-bean-definition-dsl[The Groovy Bean Definition DSL].

Further support for Groovy, including beans written in Groovy, refreshable script beans,
and more is available in xref:dynamic-language:dynamic-language.adoc#dynamic-language[dynamic-language].
