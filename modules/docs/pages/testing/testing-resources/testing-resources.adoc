...
* https://www.junit.org/[JUnit]: "`A programmer-friendly testing framework for Java`".
  ...
  xref:integration-testing:testcontext-framework.adoc#testcontext-framework[Spring TestContext Framework].
* https://testng.org/[TestNG]: A testing framework inspired by JUnit with added support
  ...
  in the xref:integration-testing:testcontext-framework.adoc#testcontext-framework[Spring TestContext Framework]
