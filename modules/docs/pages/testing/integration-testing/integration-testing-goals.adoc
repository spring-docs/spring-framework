...
* To manage xref:integration-testing:integration-testing-goals:testing-ctx-management.adoc#testing-ctx-management[Spring IoC container caching] between tests.
* To provide xref:integration-testing:integration-testing-goals:testing-fixture-di.adoc#testing-fixture-di[Dependency Injection of test fixture instances].
* To provide xref:integration-testing:integration-testing-goals:testing-tx.adoc#testing-tx[transaction management] appropriate to integration testing.
* To supply xref:integration-testing:integration-testing-goals:testing-support-classes.adoc#testing-support-classes[Spring-specific base classes] that assist
...
See xref:integration-testing:testcontext-framework:testcontext-ctx-management.adoc#testcontext-ctx-management[testcontext-ctx-management] and xref:integration-testing:testcontext-framework:testcontext-ctx-management.adoc#testcontext-ctx-management-caching[testcontext-ctx-management-caching] with the
...
xref:integration-testing:testcontext-framework:testcontext-fixture-di.adoc#testcontext-fixture-di[TestContext framework].
...
xref:integration-testing:integration-testing-annotations.adoc#integration-testing-annotations[`@Commit`] annotation.

See transaction management with the xref:integration-testing:testcontext-framework:testcontext-tx.adoc#testcontext-tx[TestContext framework].
...
* A `JdbcTemplate`, for executing SQL statements to query the database. You can use such
  ...
  to avoid xref:integration-testing:testcontext-framework:testcontext-tx.adoc#testcontext-tx-false-positives[false positives].
...
See support classes for the xref:integration-testing:testcontext-framework:testcontext-support-classes.adoc#testcontext-support-classes[TestContext framework].
