...
* xref:integration-testing:integration-testing-annotations:integration-testing-annotations-spring.adoc#integration-testing-annotations-spring[integration-testing-annotations-spring]
* xref:integration-testing:integration-testing-annotations:integration-testing-annotations-standard.adoc#integration-testing-annotations-standard[integration-testing-annotations-standard]
* xref:integration-testing:integration-testing-annotations:integration-testing-annotations-junit4.adoc#integration-testing-annotations-junit4[integration-testing-annotations-junit4]
* xref:integration-testing:integration-testing-annotations:integration-testing-annotations-junit-jupiter.adoc#integration-testing-annotations-junit-jupiter[integration-testing-annotations-junit-jupiter]
* xref:integration-testing:integration-testing-annotations:integration-testing-annotations-meta.adoc#integration-testing-annotations-meta[integration-testing-annotations-meta]
...
* xref:integration-testing:integration-testing-annotations:integration-testing-annotations-spring.adoc#spring-testing-annotation-bootstrapwith[spring-testing-annotation-bootstrapwith]
* xref:integration-testing:integration-testing-annotations:integration-testing-annotations-spring.adoc#spring-testing-annotation-contextconfiguration[spring-testing-annotation-contextconfiguration]
* xref:integration-testing:integration-testing-annotations:integration-testing-annotations-spring.adoc#spring-testing-annotation-webappconfiguration[spring-testing-annotation-webappconfiguration]
* xref:integration-testing:integration-testing-annotations:integration-testing-annotations-spring.adoc#spring-testing-annotation-contexthierarchy[spring-testing-annotation-contexthierarchy]
* xref:integration-testing:integration-testing-annotations:integration-testing-annotations-spring.adoc#spring-testing-annotation-activeprofiles[spring-testing-annotation-activeprofiles]
* xref:integration-testing:integration-testing-annotations:integration-testing-annotations-spring.adoc#spring-testing-annotation-testpropertysource[spring-testing-annotation-testpropertysource]
* xref:integration-testing:integration-testing-annotations:integration-testing-annotations-spring.adoc#spring-testing-annotation-dirtiescontext[spring-testing-annotation-dirtiescontext]
* xref:integration-testing:integration-testing-annotations:integration-testing-annotations-spring.adoc#spring-testing-annotation-testexecutionlisteners[spring-testing-annotation-testexecutionlisteners]
* xref:integration-testing:integration-testing-annotations:integration-testing-annotations-spring.adoc#spring-testing-annotation-commit[spring-testing-annotation-commit]
* xref:integration-testing:integration-testing-annotations:integration-testing-annotations-spring.adoc#spring-testing-annotation-rollback[spring-testing-annotation-rollback]
* xref:integration-testing:integration-testing-annotations:integration-testing-annotations-spring.adoc#spring-testing-annotation-beforetransaction[spring-testing-annotation-beforetransaction]
* xref:integration-testing:integration-testing-annotations:integration-testing-annotations-spring.adoc#spring-testing-annotation-aftertransaction[spring-testing-annotation-aftertransaction]
* xref:integration-testing:integration-testing-annotations:integration-testing-annotations-spring.adoc#spring-testing-annotation-sql[spring-testing-annotation-sql]
* xref:integration-testing:integration-testing-annotations:integration-testing-annotations-spring.adoc#spring-testing-annotation-sqlconfig[spring-testing-annotation-sqlconfig]
* xref:integration-testing:integration-testing-annotations:integration-testing-annotations-spring.adoc#spring-testing-annotation-sqlmergemode[spring-testing-annotation-sqlmergemode]
* xref:integration-testing:integration-testing-annotations:integration-testing-annotations-spring.adoc#spring-testing-annotation-sqlgroup[spring-testing-annotation-sqlgroup]
...
xref:integration-testing:testcontext-framework:testcontext-bootstrapping.adoc#testcontext-bootstrapping[bootstrapping the TestContext framework] for further details.
...
xref:integration-testing:testcontext-framework:testcontext-ctx-management.adoc#testcontext-ctx-management-javaconfig-component-classes[testcontext-ctx-management-javaconfig-component-classes] for further details.
...
See xref:integration-testing:testcontext-framework:testcontext-ctx-management.adoc#testcontext-ctx-management[testcontext-ctx-management] and the `@ContextConfiguration` javadocs for further
details.
...
level in the class hierarchy. See xref:integration-testing:testcontext-framework:testcontext-ctx-management.adoc#testcontext-ctx-management-ctx-hierarchies[testcontext-ctx-management-ctx-hierarchies] and the
...
xref:integration-testing:testcontext-framework:testcontext-ctx-management.adoc#testcontext-ctx-management-env-profiles-ActiveProfilesResolver[`ActiveProfilesResolver`]
and registering it by using the `resolver` attribute of `@ActiveProfiles`.

See xref:integration-testing:testcontext-framework:testcontext-ctx-management.adoc#testcontext-ctx-management-env-profiles[testcontext-ctx-management-env-profiles] and the
...
See xref:integration-testing:testcontext-framework:testcontext-ctx-management.adoc#testcontext-ctx-management-property-sources[testcontext-ctx-management-property-sources] for examples and further details.
...
xref:integration-testing:integration-testing-annotations:integration-testing-annotations-spring.adoc#spring-testing-annotation-commit[spring-testing-annotation-commit]). Rollback for integration tests in the Spring
...
See xref:integration-testing:testcontext-framework:testcontext-executing-sql.adoc#testcontext-executing-sql-declaratively[testcontext-executing-sql-declaratively] for further details.
...
* `@Transactional` (org.springframework.transaction.annotation)
  _with xref:integration-testing:testcontext-framework:testcontext-tx.adoc#testcontext-tx-attribute-support[limited attribute support]_
...
xref:integration-testing:testcontext-framework:testcontext-support-classes.adoc#testcontext-junit4-runner[SpringRunner], <<testcontext-junit4-rules, Spring's JUnit 4
rules>>, or xref:integration-testing:testcontext-framework:testcontext-support-classes.adoc#testcontext-support-classes-junit4[Spring's JUnit 4 support classes]:

* xref:integration-testing:integration-testing-annotations:integration-testing-annotations-junit4.adoc#integration-testing-annotations-junit4-ifprofilevalue[integration-testing-annotations-junit4-ifprofilevalue]
* xref:integration-testing:integration-testing-annotations:integration-testing-annotations-junit4.adoc#integration-testing-annotations-junit4-profilevaluesourceconfiguration[integration-testing-annotations-junit4-profilevaluesourceconfiguration]
* xref:integration-testing:integration-testing-annotations:integration-testing-annotations-junit4.adoc#integration-testing-annotations-junit4-timed[integration-testing-annotations-junit4-timed]
* xref:integration-testing:integration-testing-annotations:integration-testing-annotations-junit4.adoc#integration-testing-annotations-junit4-repeat[integration-testing-annotations-junit4-repeat]
...
The following annotations are supported only when used in conjunction with the
xref:integration-testing:testcontext-framework:testcontext-support-classes.adoc#testcontext-junit-jupiter-extension[`SpringExtension`] and JUnit Jupiter
(that is, the programming model in JUnit 5):

* xref:integration-testing:integration-testing-annotations:integration-testing-annotations-junit-jupiter.adoc#integration-testing-annotations-junit-jupiter-springjunitconfig[integration-testing-annotations-junit-jupiter-springjunitconfig]
* xref:integration-testing:integration-testing-annotations:integration-testing-annotations-junit-jupiter.adoc#integration-testing-annotations-junit-jupiter-springjunitwebconfig[integration-testing-annotations-junit-jupiter-springjunitwebconfig]
* xref:integration-testing:integration-testing-annotations:integration-testing-annotations-junit-jupiter.adoc#integration-testing-annotations-testconstructor[integration-testing-annotations-testconstructor]
* xref:integration-testing:integration-testing-annotations:integration-testing-annotations-junit-jupiter.adoc#integration-testing-annotations-junit-jupiter-enabledif[integration-testing-annotations-junit-jupiter-enabledif]
* xref:integration-testing:integration-testing-annotations:integration-testing-annotations-junit-jupiter.adoc#integration-testing-annotations-junit-jupiter-disabledif[integration-testing-annotations-junit-jupiter-disabledif]
...
See xref:integration-testing:testcontext-framework:testcontext-ctx-management.adoc#testcontext-ctx-management[testcontext-ctx-management] as well as the javadoc for
...
* xref:expressions:expressions.adoc#expressions[Spring Expression Language] (SpEL) expression. For example:
  `@EnabledIf("#{systemProperties['os.name'].toLowerCase().contains('mac')}")`
* Placeholder for a property available in the Spring xref:beans:beans-environment.adoc#beans-environment[`Environment`].
...
xref:beans:beans-classpath-scanning:beans-meta-annotations.adoc#beans-meta-annotations[meta-annotations] to create custom composed
