...
configuration (xref:integration-testing:testcontext-framework:testcontext-ctx-management.adoc#testcontext-ctx-management[context management],
xref:integration-testing:testcontext-framework:testcontext-fixture-di.adoc#testcontext-fixture-di[dependency injection], <<testcontext-tx,transaction
management>>), xref:integration-testing:testcontext-framework:testcontext-support-classes.adoc#testcontext-support-classes[support classes], and
xref:integration-testing:integration-testing-annotations.adoc#integration-testing-annotations[annotation support] sections.
...
the `TestContextManager` with which the listener is registered. See xref:integration-testing:testcontext-framework:testcontext-tel-config.adoc#testcontext-tel-config[testcontext-tel-config].
...
* `EventPublishingTestExecutionListener`: Publishes test execution events to the test's
  `ApplicationContext` (see xref:integration-testing:testcontext-framework:testcontext-test-execution-events.adoc#testcontext-test-execution-events[testcontext-test-execution-events]).
...
xref:integration-testing:integration-testing-annotations.adoc#integration-testing-annotations[annotation support] and the javadoc for
...
through the xref:integration-testing:testcontext-framework:testcontext-tel-config.adoc#testcontext-tel-config-automatic-discovery[aforementioned]
...
implementations by using the aforementioned xref:integration-testing:testcontext-framework:testcontext-tel-config.adoc#testcontext-tel-config-automatic-discovery[automatic discovery mechanism].
...
of `AnnotationAwareOrderComparator`, as described in xref:integration-testing:testcontext-framework:testcontext-tel-config.adoc#testcontext-tel-config-ordering[testcontext-tel-config-ordering].
...
xref:beans:context-introduction:context-functionality-events.adoc#context-functionality-events-annotation[Annotation-based Event Listeners]).
...
(see xref:integration-testing:testcontext-framework:testcontext-fixture-di.adoc#testcontext-fixture-di[testcontext-fixture-di]).
=====
...
* xref:integration-testing:testcontext-framework:testcontext-ctx-management.adoc#testcontext-ctx-management-xml[testcontext-ctx-management-xml]
* xref:integration-testing:testcontext-framework:testcontext-ctx-management.adoc#testcontext-ctx-management-groovy[testcontext-ctx-management-groovy]
* xref:integration-testing:testcontext-framework:testcontext-ctx-management.adoc#testcontext-ctx-management-javaconfig[testcontext-ctx-management-javaconfig]
* xref:integration-testing:testcontext-framework:testcontext-ctx-management.adoc#testcontext-ctx-management-mixed-config[testcontext-ctx-management-mixed-config]
* xref:integration-testing:testcontext-framework:testcontext-ctx-management.adoc#testcontext-ctx-management-initializers[testcontext-ctx-management-initializers]
* xref:integration-testing:testcontext-framework:testcontext-ctx-management.adoc#testcontext-ctx-management-inheritance[testcontext-ctx-management-inheritance]
* xref:integration-testing:testcontext-framework:testcontext-ctx-management.adoc#testcontext-ctx-management-env-profiles[testcontext-ctx-management-env-profiles]
* xref:integration-testing:testcontext-framework:testcontext-ctx-management.adoc#testcontext-ctx-management-property-sources[testcontext-ctx-management-property-sources]
* xref:integration-testing:testcontext-framework:testcontext-ctx-management.adoc#testcontext-ctx-management-web[testcontext-ctx-management-web]
* xref:integration-testing:testcontext-framework:testcontext-ctx-management.adoc#testcontext-ctx-management-caching[testcontext-ctx-management-caching]
* xref:integration-testing:testcontext-framework:testcontext-ctx-management.adoc#testcontext-ctx-management-ctx-hierarchies[testcontext-ctx-management-ctx-hierarchies]
...
xref:beans:beans-basics:beans-factory-instantiation.adoc#groovy-bean-definition-dsl[Groovy Bean Definition DSL], you can annotate
...
xref:integration-testing:testcontext-framework:testcontext-ctx-management.adoc#testcontext-ctx-management-xml[XML configuration files].
...
xref:beans:beans-java.adoc#beans-java[Java-based container configuration]), you can annotate your test
...
`WebApplicationContext`, this xref:integration-testing:testcontext-framework:testcontext-key-abstractions.adoc#testcontext-key-abstractions[`TestExecutionListener`]
...
`@DirtiesContext` in xref:integration-testing:integration-testing-annotations:integration-testing-annotations-spring.adoc#spring-testing-annotation-dirtiescontext[spring-testing-annotation-dirtiescontext]). This instructs Spring
...
xref:integration-testing:integration-testing-annotations:integration-testing-annotations-spring.adoc#spring-testing-annotation-dirtiescontext[Spring Testing Annotations] and the
...
(see xref:integration-testing:testcontext-framework:testcontext-support-classes.adoc#testcontext-junit-jupiter-di[testcontext-junit-jupiter-di]). For consistency with Spring's annotation-based
...
xref:integration-testing:integration-testing-goals.adoc#integration-testing-goals[Goals] section. The next two code listings demonstrate the
...
`LoginAction` is instantiated by using xref:expressions:expressions.adoc#expressions[SpEL expressions] that
...
xref:transaction:transaction-declarative:tx-propagation.adoc#tx-propagation[transaction propagation] for details).
...
Note that xref:integration-testing:testcontext-framework:testcontext-support-classes.adoc#testcontext-support-classes-junit4[`AbstractTransactionalJUnit4SpringContextTests`] and
xref:integration-testing:testcontext-framework:testcontext-support-classes.adoc#testcontext-support-classes-testng[`AbstractTransactionalTestNGSpringContextTests`]
...
As explained in xref:integration-testing:testcontext-framework:testcontext-tx.adoc#testcontext-tx-rollback-and-commit-behavior[testcontext-tx-rollback-and-commit-behavior], there is no need to
...
xref:integration-testing:integration-testing-annotations.adoc#integration-testing-annotations[annotation support] section for further details.
...
used. See the xref:integration-testing:integration-testing-annotations.adoc#integration-testing-annotations[annotation support] section for further
information and configuration examples. xref:integration-testing:testcontext-framework:testcontext-executing-sql.adoc#testcontext-executing-sql-declaratively-tx[Transaction management for `@Sql`] contains an additional example that uses `@Sql` for
...
xref:jdbc:jdbc-embedded-database-support.adoc#jdbc-embedded-database-support[Embedded database support] and
...
xref:integration-testing:testcontext-framework:testcontext-executing-sql.adoc#testcontext-executing-sql-declaratively-script-merging[testcontext-executing-sql-declaratively-script-merging] for further details.
...
`TransactionalTestExecutionListener` (see xref:integration-testing:testcontext-framework:testcontext-tx.adoc#testcontext-tx[transaction management] for
details).
...
via `@SqlMergeMode(OVERRIDE)`. Consult the xref:integration-testing:integration-testing-annotations:integration-testing-annotations-spring.adoc#spring-testing-annotation-sqlmergemode[`@SqlMergeMode` annotation documentation section] for examples and further details.
...
of the cache. See the discussion on xref:integration-testing:testcontext-framework:testcontext-ctx-management.adoc#testcontext-ctx-management-caching[context caching]
for details.
====
...
xref:integration-testing:testcontext-framework:testcontext-support-classes.adoc#testcontext-junit4-rules[Spring's support for JUnit rules] instead.
...
an ORM tool, be sure to avoid xref:integration-testing:testcontext-framework:testcontext-tx.adoc#testcontext-tx-false-positives[false positives].
As mentioned in xref:integration-testing:integration-testing-support-jdbc.adoc#integration-testing-support-jdbc[integration-testing-support-jdbc],
...
* Dependency injection for test constructors, test methods, and test lifecycle callback
  methods. See xref:integration-testing:testcontext-framework:testcontext-support-classes.adoc#testcontext-junit-jupiter-di[testcontext-junit-jupiter-di] for further details.
* Powerful support for link:https://junit.org/junit5/docs/current/user-guide/#extensions-conditions[conditional
  ...
  xref:integration-testing:integration-testing-annotations:integration-testing-annotations-junit-jupiter.adoc#integration-testing-annotations-junit-jupiter[integration-testing-annotations-junit-jupiter] for further details and examples.
* Custom composed annotations that combine annotations from Spring and JUnit Jupiter. See
  ...
  xref:integration-testing:integration-testing-annotations:integration-testing-annotations-meta.adoc#integration-testing-annotations-meta[integration-testing-annotations-meta] for further details.
...
xref:integration-testing:integration-testing-annotations:integration-testing-annotations-junit-jupiter.adoc#integration-testing-annotations-junit-jupiter[integration-testing-annotations-junit-jupiter] for further details.
...
See xref:integration-testing:integration-testing-annotations:integration-testing-annotations-junit-jupiter.adoc#integration-testing-annotations-testconstructor[integration-testing-annotations-testconstructor] for details on the use of
...
xref:integration-testing:integration-testing-annotations:integration-testing-annotations-junit-jupiter.adoc#integration-testing-annotations-testconstructor[integration-testing-annotations-testconstructor]), we can omit the declaration of
