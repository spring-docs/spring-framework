...
[.small]#xref:mvc:mvc-ann-async:mvc-ann-async-processing.adoc#mvc-ann-async-vs-webflux[Compared to WebFlux]#

Spring MVC has an extensive integration with Servlet 3.0 asynchronous request
xref:mvc:mvc-ann-async:mvc-ann-async-processing.adoc#mvc-ann-async-processing[processing]:

* xref:mvc:mvc-ann-async:mvc-ann-async-deferredresult.adoc#mvc-ann-async-deferredresult[`DeferredResult`] and xref:mvc:mvc-ann-async:mvc-ann-async-callable.adoc#mvc-ann-async-callable[`Callable`]
return values in controller methods and provide basic support for a single asynchronous
return value.
* Controllers can xref:mvc:mvc-ann-async:mvc-ann-async-http-streaming.adoc#mvc-ann-async-http-streaming[stream] multiple values, including
xref:mvc:mvc-ann-async:mvc-ann-async-http-streaming.adoc#mvc-ann-async-sse[SSE] and xref:mvc:mvc-ann-async:mvc-ann-async-http-streaming.adoc#mvc-ann-async-output-stream[raw data].
* Controllers can use reactive clients and return
xref:mvc:mvc-ann-async:mvc-ann-async-reactive-types.adoc#mvc-ann-async-reactive-types[reactive types] for response handling.
...
Once the asynchronous request processing feature is xref:mvc:mvc-ann-async:mvc-ann-async-configuration.adoc#mvc-ann-async-configuration[enabled]
...
xref:mvc:mvc-ann-async:mvc-ann-async-configuration.adoc#mvc-ann-async-configuration-spring-mvc[configured] `TaskExecutor`.
...
asynchronous and xref:mvc:mvc-ann-async:mvc-ann-async-reactive-types.adoc#mvc-ann-async-reactive-types[mvc-ann-async-reactive-types] as return values in controller methods.
...
=== HTTP Streaming
[.small]#xref:webflux:webflux-reactive-spring-web:webflux-codecs.adoc#webflux-codecs-streaming[WebFlux]#
...
xref:remoting:rest-client-access:rest-resttemplate.adoc#rest-message-conversion[`HttpMessageConverter`] and written to the
...
xref:websocket:websocket.adoc#websocket[WebSocket messaging] with
xref:websocket:websocket-fallback.adoc#websocket-fallback[SockJS fallback] transports (including SSE) that target
a wide range of browsers.

See also xref:mvc:mvc-ann-async:mvc-ann-async-http-streaming.adoc#mvc-ann-async-objects[previous section] for notes on exception handling.
...
xref:webflux-reactive-libraries:webflux-reactive-libraries.adoc#webflux-reactive-libraries[Reactive Libraries] in the WebFlux section).
...
xref:mvc:mvc-ann-async:mvc-ann-async-configuration.adoc#mvc-ann-async-configuration-spring-mvc[configured] `TaskExecutor`, to avoid
...
xref:mvc:mvc-ann-async:mvc-ann-async-configuration.adoc#mvc-ann-async-configuration-spring-mvc[MVC configuration] to configure a task executor.
...
Therefore, while streaming to the response, whether through xref:mvc:mvc-ann-async:mvc-ann-async-http-streaming.adoc#mvc-ann-async-sse[SseEmitter]
or xref:mvc:mvc-ann-async:mvc-ann-async-reactive-types.adoc#mvc-ann-async-reactive-types[reactive types], it is important to send data periodically,
...
xref:websocket:websocket-stomp.adoc#websocket-stomp[STOMP over WebSocket] or WebSocket with xref:websocket:websocket-fallback.adoc#websocket-fallback[SockJS])
...
xref:mvc:mvc-ann-async:mvc-ann-async-reactive-types.adoc#mvc-ann-async-reactive-types[mvc-ann-async-reactive-types] and for executing `Callable` instances returned from
