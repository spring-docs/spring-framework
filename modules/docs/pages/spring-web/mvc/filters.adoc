...
[[filters]]
== Filters
[.small]#xref:webflux:webflux-reactive-spring-web:webflux-filters.adoc#webflux-filters[WebFlux]#

The `spring-web` module provides some useful filters:

* xref:mvc:filters:filters-http-put.adoc#filters-http-put[filters-http-put]
* xref:mvc:filters:filters-forwarded-headers.adoc#filters-forwarded-headers[filters-forwarded-headers]
* xref:mvc:filters:filters-shallow-etag.adoc#filters-shallow-etag[filters-shallow-etag]
* xref:mvc:filters:filters-cors.adoc#filters-cors[filters-cors]
...
=== Forwarded Headers
[.small]#xref:webflux:webflux-reactive-spring-web:webflux-web-handler-api.adoc#webflux-forwarded-headers[WebFlux]#
...
In order to support xref:mvc:mvc-ann-async.adoc#mvc-ann-async[asynchronous requests] and error dispatches this
...
(see xref:mvc:mvc-servlet:mvc-container-config.adoc#mvc-container-config[mvc-container-config]) all filters are automatically registered for all dispatch
...
the computation. See xref:mvc:mvc-caching.adoc#mvc-caching[mvc-caching].
...
In order to support xref:mvc:mvc-ann-async.adoc#mvc-ann-async[asynchronous requests] this filter must be mapped
...
`AbstractAnnotationConfigDispatcherServletInitializer` (see xref:mvc:mvc-servlet:mvc-container-config.adoc#mvc-container-config[mvc-container-config])
...
[[filters-cors]]
=== CORS
[.small]#xref:webflux:webflux-reactive-spring-web:webflux-filters.adoc#webflux-filters-cors[WebFlux]#
...
See the sections on xref:mvc:mvc-cors.adoc#mvc-cors[mvc-cors] and the xref:mvc:mvc-cors:mvc-cors-filter.adoc#mvc-cors-filter[mvc-cors-filter] for more details.
