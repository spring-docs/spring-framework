...
[[mvc-view]]
= View Technologies
[.small]#xref:webflux:webflux-view.adoc#webflux-view[WebFlux]#
...
Spring MVC. We assume you are already familiar with xref:mvc:mvc-servlet:mvc-viewresolver.adoc#mvc-viewresolver[mvc-viewresolver].
...
[[mvc-view-thymeleaf]]
== Thymeleaf
[.small]#xref:webflux:webflux-view:webflux-view-thymeleaf.adoc#webflux-view-thymeleaf[WebFlux]#
...
[[mvc-view-freemarker]]
== FreeMarker
[.small]#xref:webflux:webflux-view:webflux-view-freemarker.adoc#webflux-view-freemarker[WebFlux]#
...
=== View Configuration
[.small]#xref:webflux:webflux-view:webflux-view-freemarker.adoc#webflux-view-freemarker-contextconfig[WebFlux]#
...
[.small]#xref:webflux:webflux-view:webflux-view-freemarker.adoc#webflux-views-freemarker[WebFlux]#
...
==== The Bind Macros
[.small]#xref:webflux:webflux-view:webflux-view-freemarker.adoc#webflux-view-bind-macros[WebFlux]#
...
[[mvc-view-script]]
== Script Views
[.small]#xref:webflux:webflux-view:webflux-view-script.adoc#webflux-view-script[WebFlux]#
...
=== Requirements
[.small]#xref:webflux:webflux-view:webflux-view-script.adoc#webflux-view-script-dependencies[WebFlux]#
...
For an example of this tag, see xref:mvc:mvc-view:mvc-view-jsp.adoc#mvc-view-jsp-formtaglib-formtag[mvc-view-jsp-formtaglib-formtag]. You can also use
...
As with the xref:mvc:mvc-view:mvc-view-jsp.adoc#mvc-view-jsp-formtaglib-checkboxestag[`checkboxes` tag], you might want to
...
[[mvc-view-jackson]]
== Jackson
[.small]#xref:webflux:webflux-view:webflux-view-httpmessagewriter.adoc#webflux-view-httpmessagewriter[WebFlux]#
...
`org.springframework.oxm` package, see xref:oxm:oxm.adoc#oxm[Marshalling XML using O/X Mappers].
...
name of our XSLT view. See xref:mvc:mvc-controller.adoc#mvc-controller[mvc-controller] for details of Spring Web MVC's
