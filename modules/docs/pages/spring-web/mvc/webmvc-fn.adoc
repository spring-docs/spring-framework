...
[.small]#xref:webflux:webflux-fn.adoc#webflux-fn[WebFlux]#
...
the same xref:mvc:mvc-servlet.adoc#mvc-servlet[mvc-servlet].
...
[[webmvc-fn-overview]]
== Overview
[.small]#xref:webflux:webflux-fn:webflux-fn-overview.adoc#webflux-fn-overview[WebFlux]#
...
@Configuration class, it will auto-detected by the servlet, as explained in xref:mvc:webmvc-fn:webmvc-fn-running.adoc#webmvc-fn-running[webmvc-fn-running].
...
== HandlerFunction
[.small]#xref:webflux:webflux-fn:webflux-fn-handler-functions.adoc#webflux-fn-handler-functions[WebFlux]#
...
== `RouterFunction`
[.small]#xref:webflux:webflux-fn:webflux-fn-router-functions.adoc#webflux-fn-router-functions[WebFlux]#
...
[[webmvc-fn-running]]
== Running a Server
[.small]#xref:webflux:webflux-fn:webflux-fn-running.adoc#webflux-fn-running[WebFlux]#

You typically run router functions in a xref:mvc:mvc-servlet.adoc#mvc-servlet[`DispatcherHandler`]-based setup through the
xref:mvc:mvc-config.adoc#mvc-config[mvc-config], which uses Spring configuration to declare the
...
[.small]#xref:webflux:webflux-fn:webflux-fn-handler-filter-function.adoc#webflux-fn-handler-filter-function[WebFlux]#
