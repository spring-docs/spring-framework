...
* STOMP clients, including a xref:websocket:websocket-stomp:websocket-stomp-client.adoc#websocket-stomp-client[Java client]
...
endpoints, over WebSocket with xref:websocket:websocket-fallback.adoc#websocket-fallback[websocket-fallback], as the following example shows:
...
overridden) on the server side. See xref:websocket:websocket-stomp:websocket-stomp-handle-broker-relay-configure.adoc#websocket-stomp-handle-broker-relay-configure[websocket-stomp-handle-broker-relay-configure]
and xref:websocket:websocket-stomp:websocket-stomp-authentication.adoc#websocket-stomp-authentication[websocket-stomp-authentication] for more information on authentication.
...
xref:websocket:websocket-server:websocket-server-runtime-configuration.adoc#websocket-server-runtime-configuration[websocket-server-runtime-configuration] applies. For Jetty, however you need to set
...
* xref:websocket:websocket-stomp:websocket-stomp-handle-annotations.adoc#websocket-stomp-message-mapping[websocket-stomp-message-mapping]
* xref:websocket:websocket-stomp:websocket-stomp-handle-annotations.adoc#websocket-stomp-subscribe-mapping[websocket-stomp-subscribe-mapping]
* xref:websocket:websocket-stomp:websocket-stomp-handle-annotations.adoc#websocket-stomp-exception-handler[websocket-stomp-exception-handler]
...
xref:websocket:websocket-stomp:websocket-stomp-destination-separator.adoc#websocket-stomp-destination-separator[websocket-stomp-destination-separator].
...
to only the user associated with the input message. See xref:websocket:websocket-stomp:websocket-stomp-user-destination.adoc#websocket-stomp-user-destination[websocket-stomp-user-destination].
...
See xref:websocket:websocket-stomp:websocket-stomp-handle-send.adoc#websocket-stomp-handle-send[websocket-stomp-handle-send].
...
xref:websocket:websocket-stomp:websocket-stomp-handle-annotations.adoc#websocket-stomp-message-mapping[method arguments] as `@MessageMapping`. However
...
xref:websocket:websocket-stomp:websocket-stomp-client.adoc#websocket-stomp-client[STOMP client], you could do the following to add a receipt:
...
A server side option is xref:websocket:websocket-stomp:websocket-stomp-interceptors.adoc#websocket-stomp-interceptors[to register] an
...
xref:websocket:websocket-stomp:websocket-stomp-handle-annotations.adoc#websocket-stomp-message-mapping[`@MessageMapping`] methods.
...
xref:mvc:mvc-controller:mvc-ann-controller-advice.adoc#mvc-ann-controller-advice[similar support] available in Spring MVC.
...
See xref:websocket:websocket-stomp:websocket-stomp-destination-separator.adoc#websocket-stomp-destination-separator[websocket-stomp-destination-separator].
...
in xref:websocket:websocket-stomp:websocket-stomp-handle-send.adoc#websocket-stomp-handle-send[websocket-stomp-handle-send], to broadcast messages to subscribed WebSocket clients.
...
need not set those headers. They are ignored. As the xref:websocket:websocket-stomp:websocket-stomp-authentication.adoc#websocket-stomp-authentication[websocket-stomp-authentication]
...
xref:websocket:websocket-stomp:websocket-stomp-appplication-context-events.adoc#websocket-stomp-appplication-context-events[websocket-stomp-appplication-context-events] provide notifications for the lifecycle
...
xref:websocket:websocket-fallback:websocket-fallback-sockjs-client.adoc#websocket-fallback-sockjs-client[websocket-fallback-sockjs-client].
...
recommended to review xref:websocket:websocket-stomp:websocket-stomp-message-flow.adoc#websocket-stomp-message-flow[websocket-stomp-message-flow].
