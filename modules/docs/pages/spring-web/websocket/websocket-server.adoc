...
[[websocket-server]]
== WebSocket API
[.small]#xref:webflux-websocket:webflux-websocket-server.adoc#webflux-websocket-server[WebFlux]#
...
=== `WebSocketHandler`
[.small]#xref:webflux-websocket:webflux-websocket-server:webflux-websocket-server-handler.adoc#webflux-websocket-server-handler[WebFlux]#
...
in the configuration of a xref:mvc:mvc-servlet.adoc#mvc-servlet[`DispatcherServlet`]. However, Spring's
...
xref:websocket:websocket-stomp.adoc#websocket-stomp[websocket-stomp] messaging, the application must synchronize the sending of messages
...
=== WebSocket Handshake
[.small]#xref:webflux-websocket:webflux-websocket-server:webflux-websocket-server-handshake.adoc#webflux-websocket-server-handshake[WebFlux]#
...
(see xref:websocket:websocket-server:websocket-server-deployment.adoc#websocket-server-deployment[websocket-server-deployment] for more on this subject).
...
[.small]#xref:webflux-websocket:webflux-websocket-server:webflux-websocket-server-config.adoc#webflux-websocket-server-config[WebFlux]#
...
=== Allowed Origins
[.small]#xref:webflux-websocket:webflux-websocket-server:webflux-websocket-server-cors.adoc#webflux-websocket-server-cors[WebFlux]#
