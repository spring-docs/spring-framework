...
* xref:jdbc:jdbc-connections:jdbc-datasource.adoc#jdbc-datasource[jdbc-datasource]
* xref:jdbc:jdbc-connections:jdbc-datasource.adoc#jdbc-DataSourceUtils[jdbc-DataSourceUtils]
* xref:jdbc:jdbc-connections:jdbc-DataSourceUtils.adoc#jdbc-SmartDataSource[jdbc-SmartDataSource]
* xref:jdbc:jdbc-connections:jdbc-SmartDataSource.adoc#jdbc-AbstractDataSource[jdbc-AbstractDataSource]
* xref:jdbc:jdbc-connections:jdbc-AbstractDataSource.adoc#jdbc-SingleConnectionDataSource[jdbc-SingleConnectionDataSource]
* xref:jdbc:jdbc-connections:jdbc-SingleConnectionDataSource.adoc#jdbc-DriverManagerDataSource[jdbc-DriverManagerDataSource]
* xref:jdbc:jdbc-connections:jdbc-DriverManagerDataSource.adoc#jdbc-TransactionAwareDataSourceProxy[jdbc-TransactionAwareDataSourceProxy]
* xref:jdbc:jdbc-connections:jdbc-TransactionAwareDataSourceProxy.adoc#jdbc-DataSourceTransactionManager[jdbc-DataSourceTransactionManager]
