...
* xref:jdbc:jdbc-embedded-database-support:jdbc-embedded-database-types.adoc#jdbc-embedded-database-using-HSQL[jdbc-embedded-database-using-HSQL]
* xref:jdbc:jdbc-embedded-database-support:jdbc-embedded-database-types.adoc#jdbc-embedded-database-using-H2[jdbc-embedded-database-using-H2]
* xref:jdbc:jdbc-embedded-database-support:jdbc-embedded-database-types.adoc#jdbc-embedded-database-using-Derby[jdbc-embedded-database-using-Derby]
...
consider using the xref:integration-testing:testcontext-framework.adoc#testcontext-framework[Spring TestContext Framework] and
configuring the embedded database as a bean in the Spring `ApplicationContext` as described
in xref:jdbc:jdbc-embedded-database-support:jdbc-embedded-database-xml.adoc#jdbc-embedded-database-xml[jdbc-embedded-database-xml] and xref:jdbc:jdbc-embedded-database-support:jdbc-embedded-database-java.adoc#jdbc-embedded-database-java[jdbc-embedded-database-java]. The following listing
