...
* xref:jdbc:jdbc-core.adoc#jdbc-JdbcTemplate[jdbc-JdbcTemplate]
* xref:jdbc:jdbc-core:jdbc-JdbcTemplate.adoc#jdbc-NamedParameterJdbcTemplate[jdbc-NamedParameterJdbcTemplate]
* xref:jdbc:jdbc-core:jdbc-NamedParameterJdbcTemplate.adoc#jdbc-SQLExceptionTranslator[jdbc-SQLExceptionTranslator]
* xref:jdbc:jdbc-core:jdbc-statements-executing.adoc#jdbc-statements-executing[jdbc-statements-executing]
* xref:jdbc:jdbc-core:jdbc-statements-querying.adoc#jdbc-statements-querying[jdbc-statements-querying]
* xref:jdbc:jdbc-core:jdbc-updates.adoc#jdbc-updates[jdbc-updates]
* xref:jdbc:jdbc-core:jdbc-auto-generated-keys.adoc#jdbc-auto-generated-keys[jdbc-auto-generated-keys]
...
hierarchy defined in the `org.springframework.dao` package. (See xref:dao:dao-exceptions.adoc#dao-exceptions[dao-exceptions].)
...
More sophisticated stored procedure support is xref:jdbc:jdbc-object:jdbc-SqlUpdate.adoc#jdbc-StoredProcedure[covered later].
...
xref:jdbc:jdbc-core:jdbc-JdbcTemplate.adoc#jdbc-NamedParameterJdbcTemplate[`NamedParameterJdbcTemplate`] class) is to
...
See also xref:jdbc:jdbc-core:jdbc-JdbcTemplate.adoc#jdbc-JdbcTemplate-idioms[jdbc-JdbcTemplate-idioms] for guidelines on using the
