...
xref:transaction:transaction-programmatic:transaction-programmatic-ptm.adoc#transaction-programmatic-ptm[programmatically] from your application code. Because
...
* Propagation: Typically, all code executed within a transaction scope runs in
  ...
  about the semantics of transaction propagation in Spring, see xref:transaction:transaction-declarative:tx-propagation.adoc#tx-propagation[tx-propagation].
...
xref:appendix:xsd-schemas:xsd-schemas-jee.adoc#xsd-schemas-jee[The JEE Schema].
