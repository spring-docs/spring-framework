...
* xref:appendix:xsd-schemas:xsd-schemas-tx.adoc#xsd-schemas-tx[xsd-schemas-tx]
* xref:appendix:xsd-schemas:xsd-schemas-jdbc.adoc#xsd-schemas-jdbc[xsd-schemas-jdbc]
...
xref:jdbc:jdbc-initializing-datasource.adoc#jdbc-initializing-datasource[Initializing a DataSource], respectively.
