...
* xref:orm:orm-jpa:orm-jpa-setup.adoc#orm-jpa-setup-lemfb[orm-jpa-setup-lemfb]
* xref:orm:orm-jpa:orm-jpa-setup.adoc#orm-jpa-setup-jndi[orm-jpa-setup-jndi]
* xref:orm:orm-jpa:orm-jpa-setup.adoc#orm-jpa-setup-lcemfb[orm-jpa-setup-lcemfb]
...
See xref:orm:orm-jpa:orm-jpa-hibernate.adoc#orm-jpa-hibernate[Native Hibernate setup for JPA interaction] for details.
...
See the xref:aop:aop-using-aspectj:aop-aj-ltw.adoc#aop-aj-ltw-spring[Spring configuration] in the AOP chapter for
...
As described in xref:aop:aop-using-aspectj:aop-aj-ltw.adoc#aop-aj-ltw-spring[Spring configuration], you can configure
...
NOTE: We strongly encourage you to read xref:transaction:transaction-declarative.adoc#transaction-declarative[transaction-declarative], if you have not
...
See the xref:orm:orm-jpa:orm-jpa-dialect.adoc#orm-jpa-dialect[next section] for details on the `JpaDialect` mechanism.
...
See xref:orm:orm-hibernate:orm-hibernate-invalid-jdbc-access-error.adoc#orm-hibernate-invalid-jdbc-access-error[orm-hibernate-invalid-jdbc-access-error] for a related note about WebLogic.
...
See xref:orm:orm-jpa:orm-jpa-setup.adoc#orm-jpa-setup-background[Background Bootstrapping] for an introduction.
